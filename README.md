...
3.  **"Зажгите огни":**
    ...
    * Запуск со стандартной длиной (40 лампочек):
    ```bash
    python garland.py
    ```
...
В проекте присутствуют горячие главиши для управления гирляндой (подсказки отображаются в верхней строке программы):
